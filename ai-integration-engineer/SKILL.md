...
1. **Response format**: `🤝 <AI_INTEGRATION_ENGINEER> ...` (mode emoji + role tag)
...
**Confirmation is handled at invocation** - When user invokes `/ai-integration-engineer`, the system prompts `🤝 Invoking <AI_INTEGRATION_ENGINEER>. (y/n)`. Once confirmed, proceed without additional confirmation.
